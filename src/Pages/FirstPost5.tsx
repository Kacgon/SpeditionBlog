...
export function FirstPost5({}:FirstPostProp){
    ...
    <img className="ImageFirstPost" src="https://source.unsplash.com/random/{Number6}"></img>
    <div className="BanerFirstPost"><p className="InsideOfBanner">Co nowego?</p></div>
        <Card.Title >
    <span className="postsTitle">{dane[22].title}</span>
        </Card.Title>
    <p>{dane[22].body}</p>
