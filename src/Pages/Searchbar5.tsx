...
import {Number1} from "./SmallPostsApi5"
...
export default function SearchBar4(){
    ...
    const getData = () => {
        ...
        var FilteredData = [data[Number1]?.title, data[Number1+1]?.title,  data[Number1+2]?.title,data[Number1+3]?.title,data[Number1+4]?.title,data[22]?.title]
