...
import { FirstPost5 } from './FirstPost5'
import SmallPostsApi5 from "./SmallPostsApi5"
...
function Page5() {
  return (
    ...
    <Grid className='AppFullContainer2' container lg={12}>
      ...
      <Grid item lg={12}>
          <div className='FirstPost'> <FirstPost5 userId={''} id={0} title={''} body={''} /></div>
      </Grid>
      <Grid item xs={12}>
          <div className='SingleSmallPost'><SmallPostsApi5 />
          </div>
      ...
      <div className='searchBar'><SearchBar5 /></div>
